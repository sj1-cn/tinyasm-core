...
public interface WithDefineStaticField<T> {
	...
	default T staticField(List<Field> fields) {
		...
		for (Field field : fields) {
			t = staticField(field.name, GenericClazz.generic(field.clazz));
		}
		return t;
	}
	...
	default T staticField(String name, GenericClazz clazz) {
		return staticField(ACC_PRIVATE, name, GenericClazz.generic(clazz));
	}
	...
	default T staticField(String name, String clazz, boolean isarray) {
		return staticField(name, GenericClazz.generic(clazz, isarray));
	}
	...
	default T staticField(Class<?> annotation, String name, String clazz, boolean isarray) {
		return staticField(Annotation.annotation(annotation), name, GenericClazz.generic(clazz, isarray));
	}
	...
	default T staticField(int access, String name, String clazz, boolean isarray) {
		return staticField(access, name, GenericClazz.generic(clazz, isarray));
	}
	...
	default T staticField(int access, Class<?> annotation, String name, String clazz, boolean isarray) {
		return staticField(access, Annotation.annotation(annotation), name, GenericClazz.generic(clazz, isarray));
	}
