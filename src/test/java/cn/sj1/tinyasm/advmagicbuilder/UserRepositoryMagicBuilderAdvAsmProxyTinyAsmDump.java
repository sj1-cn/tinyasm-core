...
import cn.sj1.tinyasm.ClassBody;
import cn.sj1.tinyasm.advmagicbuilder.User;
import java.lang.Object;
import java.lang.Class;
import java.lang.StringBuilder;
import cn.sj1.tinyasm.advmagicbuilder.RepositoryMagicBuilder;
...
public class UserRepositoryMagicBuilderAdvAsmProxyTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new UserRepositoryMagicBuilderAdvAsmProxyTinyAsmDump().dump("cn.sj1.tinyasm.advmagicbuilder.UserRepositoryMagicBuilderAdvAsmProxy");
	}
...
classBody.referInnerClass(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "java.lang.invoke.MethodHandles", "Lookup");
	...
	protected void _update(ClassBody classBody) {
		...
		code.visitInvokeDynamicInsn("accept", "(Lcn/sj1/tinyasm/advmagicbuilder/UserRepositoryMagicBuilderAdvAsmProxy;Lcn/sj1/tinyasm/ConsumerWithException;Lcn/sj1/tinyasm/ConsumerWithException;)Lcn/sj1/tinyasm/ConsumerWithException;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "cn/sj1/tinyasm/advmagicbuilder/UserRepositoryMagicBuilderAdvAsmProxy", "lambda$update$0", "(Lcn/sj1/tinyasm/ConsumerWithException;Lcn/sj1/tinyasm/ConsumerWithException;Lcn/sj1/tinyasm/MethodCode;)V", false), Type.getType("(Lcn/sj1/tinyasm/MethodCode;)V")});
	...
	protected void __update(ClassBody classBody) {
		...
		code.LINE();
		code.LOAD("code");
		code.LOADConst(Type.getType("Lcn/sj1/tinyasm/advmagicbuilder/User;"));
