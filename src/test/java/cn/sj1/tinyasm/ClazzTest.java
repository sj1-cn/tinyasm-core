...
public class ClazzTest {
	...
	public void testClazzTypeTypeArray() {
		assertEquals("[Lcn/sj1/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).toString());
	}

	@Test
	public void testClazzTypeType() {
		assertEquals("Lcn/sj1/tinyasm/ClazzTest;", new ClazzSimple(Type.getType(ClazzTest.class)).toString());
	}

	@Test
	public void testClazzTypeClassOfQ() {
		assertEquals("Lcn/sj1/tinyasm/ClazzTest;", new ClazzSimple(ClazzTest.class).toString());
	}
	...
	public void testGetType() {
		assertEquals("[Lcn/sj1/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).getType().getDescriptor());
	}

	@Test
	public void testSignatureAnyway() {
		assertEquals("[Lcn/sj1/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).signatureAnyway());
	}
	...
	public void testGetDescriptor() {
		assertEquals("[Lcn/sj1/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).getDescriptor());
	}

	@Test
	public void testSignatureOf() {
		assertEquals("[Lcn/sj1/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).signatureOf());
	}
