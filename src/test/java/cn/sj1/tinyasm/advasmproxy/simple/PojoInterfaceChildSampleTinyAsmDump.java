...
import cn.sj1.tinyasm.advasmproxy.simple.PojoInterfaceSample;
...
public class PojoInterfaceChildSampleTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new PojoInterfaceChildSampleTinyAsmDump().dump("cn.sj1.tinyasm.advasmproxy.simple.PojoInterfaceChildSample");
	}
