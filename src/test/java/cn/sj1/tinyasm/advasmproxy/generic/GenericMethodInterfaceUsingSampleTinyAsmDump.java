...
import cn.sj1.tinyasm.advasmproxy.generic.GenericMethodInterface;
import java.lang.Integer;
@SuppressWarnings("unused")
public class GenericMethodInterfaceUsingSampleTinyAsmDump {

	public static byte[] dump () throws Exception {
		return new GenericMethodInterfaceUsingSampleTinyAsmDump().dump("cn.sj1.tinyasm.advasmproxy.generic.GenericMethodInterfaceUsingSample");
	}
