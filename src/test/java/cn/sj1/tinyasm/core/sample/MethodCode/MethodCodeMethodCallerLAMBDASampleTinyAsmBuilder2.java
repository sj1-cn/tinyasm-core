...
public class MethodCodeMethodCallerLAMBDASampleTinyAsmBuilder2 {

	public static byte[] dump() throws Exception {
		return new MethodCodeMethodCallerLAMBDASampleTinyAsmBuilder2().build("cn.sj1.tinyasm.core.sample.MethodCode.MethodCodeMethodCallerLAMBDASample");
	}
