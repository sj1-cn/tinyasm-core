...
public class MethodCodeLogicSampleTinyAsmDump {

	public static byte[] dump() throws Exception {
		return new MethodCodeLogicSampleTinyAsmDump().build("cn.sj1.tinyasm.core.sample.MethodCode.MethodCodeLogicSample");
	}
