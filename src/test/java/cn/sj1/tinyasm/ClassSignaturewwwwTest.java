...
//		assertEquals(0, classSignaturewwww.typeParamenterClazzes.length);
	...
	public void test_typesssParameterClass() {
		String signature = "Ljava/lang/Object;Lcn/sj1/tinyasm/hero/helperclass/GenericInterface<Lcn/sj1/tinyasm/hero/helperclass/PojoClassSample;Lcn/sj1/tinyasm/hero/helperclass/PojoClassSample;>;";
		ClassSignaturewwww classSignaturewwww = new ClassSignaturewwww(Opcodes.ASM9);
		SignatureReader sr = new SignatureReader(signature);
		sr.accept(classSignaturewwww);
		classSignaturewwww.finish();
		assertEquals(
				"Lcn/sj1/tinyasm/hero/helperclass/GenericInterface<Lcn/sj1/tinyasm/hero/helperclass/PojoClassSample;Lcn/sj1/tinyasm/hero/helperclass/PojoClassSample;>;",
...
//	
	...
	public void test_basetypessssss() {
		String signature = "(ILjava/util/Collection<+Lcn/sj1/tinyasm/hero/helperclass/PojoClassSample;>;)Z";
		ClassSignaturewwww classSignaturewwww = new ClassSignaturewwww(Opcodes.ASM9);
		SignatureReader sr = new SignatureReader(signature);
		sr.accept(classSignaturewwww);
		classSignaturewwww.finish();
...
//		assertEquals(null, classSignaturewwww.returnClazz);
		...
		assertEquals("Ljava/util/Collection<+Lcn/sj1/tinyasm/hero/helperclass/PojoClassSample;>;",
...
//		assertEquals(null, classSignaturewwww.returnClazz);
		...
		assertEquals("Ljava/util/function/Consumer<-Lcn/sj1/tinyasm/advasmproxy/simple/PojoClass;>;",
