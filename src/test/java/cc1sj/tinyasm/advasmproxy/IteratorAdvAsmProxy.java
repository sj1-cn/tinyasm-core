...
public class IteratorAdvAsmProxy implements Iterator<PojoClassSample>, AdvRuntimeReferNameObject {
	...
	@Override
	public void forEachRemaining(Consumer<? super PojoClassSample> param0) {
		AdvContext context = _contextThreadLocal.get();
