...
import cc1sj.tinyasm.advasmproxy.simple.SimpleSuperClass;
import cc1sj.tinyasm.advasmproxy.simple.SimplePojoClass;
import java.lang.String;
import cc1sj.tinyasm.advasmproxy.simple.SimpleSuperInterface;
@SuppressWarnings("unused")
public class SimplePojoClassUsingSampleTinyAsmDump {

	public static byte[] dump () throws Exception {
		return new SimplePojoClassUsingSampleTinyAsmDump().dump("cc1sj.tinyasm.advasmproxy.simple.SimplePojoClassUsingSample");
	}
