...
import cc1sj.tinyasm.advasmproxy.simple.PojoInterfaceSample;
@SuppressWarnings("unused")
public class PojoInterfaceChildSampleTinyAsmDump {

	public static byte[] dump () throws Exception {
		return new PojoInterfaceChildSampleTinyAsmDump().dump("cc1sj.tinyasm.advasmproxy.simple.PojoInterfaceChildSample");
	}
