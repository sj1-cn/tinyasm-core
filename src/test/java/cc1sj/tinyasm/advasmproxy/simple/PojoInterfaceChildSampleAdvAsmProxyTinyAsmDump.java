...
import cc1sj.tinyasm.advasmproxy.simple.PojoInterfaceChildSample;
...
public class PojoInterfaceChildSampleAdvAsmProxyTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new PojoInterfaceChildSampleAdvAsmProxyTinyAsmDump().dump("cc1sj.tinyasm.advasmproxy.simple.PojoInterfaceChildSampleAdvAsmProxy");
	}
