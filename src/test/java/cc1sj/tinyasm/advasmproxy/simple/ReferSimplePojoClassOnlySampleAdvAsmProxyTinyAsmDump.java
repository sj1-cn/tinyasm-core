...
import cc1sj.tinyasm.advasmproxy.simple.ReferSimplePojoClassOnlySample;
...
public class ReferSimplePojoClassOnlySampleAdvAsmProxyTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new ReferSimplePojoClassOnlySampleAdvAsmProxyTinyAsmDump().dump("cc1sj.tinyasm.advasmproxy.simple.ReferSimplePojoClassOnlySampleAdvAsmProxy");
	}
...
classBody.referInnerClass(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "java.lang.invoke.MethodHandles", "Lookup");
	...
	protected void _get__TargetClazz(ClassBody classBody) {
		...
		code.LINE();
		code.LOADConst(Type.getType("Lcc1sj/tinyasm/advasmproxy/simple/ReferSimplePojoClassOnlySample;"));
