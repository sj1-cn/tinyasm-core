...
public class SimplePojoClassSampleUsingSampleMagicBuilderAdvAsmProxyTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new SimplePojoClassSampleUsingSampleMagicBuilderAdvAsmProxyTinyAsmDump().dump("cc1sj.tinyasm.advasmproxy.simple.SimplePojoClassSampleUsingSampleMagicBuilderAdvAsmProxy");
	}
...
classBody.referInnerClass(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "java.lang.invoke.MethodHandles", "Lookup");
	...
	protected void _sayHello(ClassBody classBody) {
		...
		code.LOAD("this");
		code.LOAD("objEval");
		code.visitInvokeDynamicInsn("accept", "(Lcc1sj/tinyasm/advasmproxy/simple/SimplePojoClassSampleUsingSampleMagicBuilderAdvAsmProxy;Lcc1sj/tinyasm/ConsumerWithException;)Lcc1sj/tinyasm/ConsumerWithException;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "cc1sj/tinyasm/advasmproxy/simple/SimplePojoClassSampleUsingSampleMagicBuilderAdvAsmProxy", "lambda$sayHello$0", "(Lcc1sj/tinyasm/ConsumerWithException;Lcc1sj/tinyasm/MethodCode;)V", false), Type.getType("(Lcc1sj/tinyasm/MethodCode;)V")});
