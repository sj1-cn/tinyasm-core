...
public class GenericInterfaceImplSampleAdvAsmProxy extends GenericInterfaceImplSample implements AdvRuntimeReferNameObject {
	...
	public Clazz get__TargetClazz() {
		return Clazz.of(GenericInterfaceImplSample.class);
	}
	...
	public PojoClassSample getT() {
		...
		byte codeIndex = context.push(PojoClassSample.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(GenericInterfaceImplSample.class, "getT").return_(PojoClassSample.class).INVOKE();
		});
	...
	public PojoClassChildSample getPojoClassChildSample() {
		...
		byte codeIndex = context.push(PojoClassChildSample.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(GenericInterfaceImplSample.class, "getPojoClassChildSample").return_(PojoClassChildSample.class).INVOKE();
		});
	...
	public void setT(PojoClassSample param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(GenericInterfaceImplSample.class, "setT").parameter(Object.class).INVOKE();
		});
	}
