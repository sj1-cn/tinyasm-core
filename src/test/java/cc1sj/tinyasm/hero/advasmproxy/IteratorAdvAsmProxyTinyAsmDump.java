...
public class IteratorAdvAsmProxyTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new IteratorAdvAsmProxyTinyAsmDump().dump("cc1sj.tinyasm.hero.advasmproxy.IteratorAdvAsmProxy");
	}

	public byte[] dump(String className) throws Exception {
		ClassBody classBody = ClassBuilder.make(className, Clazz.of(Object.class),Clazz.of(Iterator.class,Clazz.of(PojoClassSample.class)),Clazz.of(AdvRuntimeReferNameObject.class))
...
classBody.referInnerClass(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "java.lang.invoke.MethodHandles", "Lookup");
	...
	protected void _remove(ClassBody classBody) {
		MethodCode code = classBody.publicMethod("remove").begin();
