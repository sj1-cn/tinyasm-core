...
public class PojoClassChildSampleAdvAsmProxy extends PojoClassChildSample implements AdvRuntimeReferNameObject {
	...
	public Clazz get__TargetClazz() {
		return Clazz.of(PojoClassChildSample.class);
	}
...
//	}
	...
	public String getName() {
		...
		byte codeIndex = context.push(String.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getName").return_(String.class).INVOKE();
		});
	...
	public boolean isAgeBoolean() {
		...
		context.push(boolean.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "isAgeBoolean").return_(boolean.class).INVOKE();
		});
		return false;
	}
	...
	public byte getAgeByte() {
		...
		byte codeIndex = context.push(byte.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeByte").return_(byte.class).INVOKE();
		});
	...
	public char getAgeChar() {
		...
		byte codeIndex = context.push(char.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeChar").return_(char.class).INVOKE();
		});
	...
	public short getAgeShort() {
		...
		byte codeIndex = context.push(short.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeShort").return_(short.class).INVOKE();
		});
	...
	public int getAgeInt() {
		...
		byte codeIndex = context.push(int.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeInt").return_(int.class).INVOKE();
		});
	...
	public long getAgeLong() {
		...
		byte codeIndex = context.push(long.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeLong").return_(long.class).INVOKE();
		});
	...
	public float getAgeFloat() {
		...
		byte codeIndex = context.push(float.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeFloat").return_(float.class).INVOKE();
		});
	...
	public double getAgeDouble() {
		...
		byte codeIndex = context.push(double.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeDouble").return_(double.class).INVOKE();
		});
	...
	public Boolean getAgeBoolean2() {
		...
		context.push(Boolean.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeBoolean2").return_(Boolean.class).INVOKE();
		});
		return false;
	}
	...
	public Byte getAgeByte2() {
		...
		byte codeIndex = context.push(Byte.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeByte2").return_(Byte.class).INVOKE();
		});
		return (byte) (MAGIC_CODES_NUMBER + codeIndex); // Byte.class);
	}
	...
	public Character getAgeCharacter() {
		...
		byte codeIndex = context.push(Character.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeCharacter").return_(Character.class).INVOKE();
		});
	...
	public Short getAgeShort2() {
		...
		byte codeIndex = context.push(Short.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeShort2").return_(Short.class).INVOKE();
		});
		return (short) (MAGIC_CODES_NUMBER + codeIndex);// Short.class);
	}
	...
	public Integer getAgeInteger() {
		...
		byte codeIndex = context.push(Integer.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeInteger").return_(Integer.class).INVOKE();
		});
	...
	public Long getAgeLong2() {
		...
		byte codeIndex = context.push(Long.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeLong2").return_(Long.class).INVOKE();
		});
	...
	public Float getAgeFloat2() {
		...
		byte codeIndex = context.push(Float.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeFloat2").return_(Float.class).INVOKE();
		});
	...
	public Double getAgeDouble2() {
		...
		byte codeIndex = context.push(Double.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getAgeDouble2").return_(Double.class).INVOKE();
		});
	...
	public void setName(String param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setName").parameter(String.class).INVOKE();
		});
	}
	...
	public void setAgeBoolean(boolean param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeBoolean").parameter(boolean.class).INVOKE();
		});
	}
	...
	public void setAgeByte(byte param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeByte").parameter(byte.class).INVOKE();
		});
	...
	public void setAgeChar(char param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeChar").parameter(char.class).INVOKE();
		});
	}
	...
	public void setAgeShort(short param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeShort").parameter(short.class).INVOKE();
		});
	...
	public void setAgeInt(int param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeInt").parameter(int.class).INVOKE();
		});
	...
	public void setAgeLong(long param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeLong").parameter(long.class).INVOKE();
		});
	...
	public void setAgeFloat(float param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeFloat").parameter(float.class).INVOKE();
		});
	...
	public void setAgeDouble(double param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeDouble").parameter(double.class).INVOKE();
		});
	...
	public void setAgeBoolean2(Boolean param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeBoolean2").parameter(Boolean.class).INVOKE();
		});
	...
	public void setAgeByte2(Byte param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeByte2").parameter(Byte.class).INVOKE();
		});
	...
	public void setAgeCharacter(Character param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeCharacter").parameter(Character.class).INVOKE();
		});
	...
	public void setAgeShort2(Short param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeShort2").parameter(Short.class).INVOKE();
		});
	...
	public void setAgeInteger(Integer param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeInteger").parameter(Integer.class).INVOKE();
		});
	...
	public void setAgeLong2(Long param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeLong2").parameter(Long.class).INVOKE();
		});
	...
	public void setAgeFloat2(Float param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeFloat2").parameter(Float.class).INVOKE();
		});
	...
	public void setAgeDouble2(Double param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(PojoClassChildSample.class, "setAgeDouble2").parameter(Double.class).INVOKE();
		});
	...
	public int getIntHelloClassChild() {
		...
		byte codeIndex = context.push(int.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getIntHelloClassChild").return_(int.class).INVOKE();
		});
	...
	public String getStringHelloClassChild() {
		...
		byte codeIndex = context.push(String.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(PojoClassChildSample.class, "getStringHelloClassChild").return_(String.class).INVOKE();
		});
		return new StringBuilder(MAGIC_CODES_String).append(codeIndex).toString(); // String.class);
	}
