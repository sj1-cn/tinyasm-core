...
public class AdvAsmProxyWithReferReferAdvAsmProxyTinyAsmDump {

	public static byte[] dump () throws Exception {
		return new AdvAsmProxyWithReferReferAdvAsmProxyTinyAsmDump().dump("cc1sj.tinyasm.hero.helperclass.AdvAsmProxyWithReferReferAdvAsmProxy");
	}

	public byte[] dump(String className) throws Exception {
		ClassBody classBody = ClassBuilder.make(className, AdvAsmProxyWithReferRefferSample.class, AdvRuntimeReferNameObject.class)
...
classBody.referInnerClass(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "java.lang.invoke.MethodHandles", "Lookup");
	...
	protected void __init_(ClassBody classBody) {
		...
		code.LINE();
		code.LOAD("this");
		code.SPECIAL(AdvAsmProxyWithReferRefferSample.class, "<init>").INVOKE();
		code.RETURN();
	...
	protected void _getRefer(ClassBody classBody) {
		...
		code.LOAD("objEval");
		code.visitInvokeDynamicInsn("accept", "(Lcc1sj/tinyasm/ConsumerWithException;)Lcc1sj/tinyasm/ConsumerWithException;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "cc1sj/tinyasm/hero/helperclass/AdvAsmProxyWithReferReferAdvAsmProxy", "lambda$getRefer$0", "(Lcc1sj/tinyasm/ConsumerWithException;Lcc1sj/tinyasm/MethodCode;)V", false), Type.getType("(Lcc1sj/tinyasm/MethodCode;)V")});
	...
	protected void _lambda$getRefer$0(ClassBody classBody) {
		MethodCode code = classBody.staticMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getRefer$0")
		...
		code.LINE();
		code.LOAD("c");
		code.LOADConst(Type.getType("Lcc1sj/tinyasm/hero/helperclass/AdvAsmProxyWithReferRefferSample;"));
		code.LOADConst("getRefer");
