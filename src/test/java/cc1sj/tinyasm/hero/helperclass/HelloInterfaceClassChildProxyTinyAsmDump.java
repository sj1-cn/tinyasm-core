...
public class HelloInterfaceClassChildProxyTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new HelloInterfaceClassChildProxyTinyAsmDump().__dump__("cc1sj.tinyasm.hero.helperclass.HelloInterfaceClassChildProxy");
	}

	public byte[] __dump__(String className) throws Exception {
		ClassBody classBody = ClassBuilder.make(className, HelloInterfaceClassChild.class).access(ACC_PUBLIC | ACC_SUPER).body();
