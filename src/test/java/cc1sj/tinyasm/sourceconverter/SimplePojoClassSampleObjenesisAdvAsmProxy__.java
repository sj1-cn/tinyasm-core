...
public class SimplePojoClassSampleObjenesisAdvAsmProxy__ extends SimplePojoClassSample
	...
	public void sayHello() {
		...
		context.execLine(c -> {
			objEval.accept(c);
			c.VIRTUAL(SimplePojoClassSample.class, "sayHello").INVOKE();
		});
	}
	...
	public String getHelloString() {
		...
		byte codeIndex = context.push(String.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(SimplePojoClassSample.class, "getHelloString").reTurn(String.class).INVOKE();
		});
	...
	public void setHelloString(String param0) {
		...
		context.execLine(c -> {
			...
			c.VIRTUAL(SimplePojoClassSample.class, "setHelloString").parameter(String.class).INVOKE();
		});
	}
	...
	public boolean beGood() {
		...
		context.push(boolean.class, c -> {
			objEval.accept(c);
			c.VIRTUAL(SimplePojoClassSample.class, "beGood").reTurn(boolean.class).INVOKE();
		});
		return false;
	}
}
