...
import cc1sj.tinyasm.advmagicbuilder.sourceconverter.SimpleSuperClass;
import cc1sj.tinyasm.hero.helperclass.SimplePojoClassSample;
import java.lang.String;
import cc1sj.tinyasm.advmagicbuilder.sourceconverter.SimpleSuperInterface;
@SuppressWarnings("unused")
public class UsingSimplePojoClassSampleTinyAsmDump {

	public static byte[] dump () throws Exception {
		return new UsingSimplePojoClassSampleTinyAsmDump().dump("cc1sj.tinyasm.advmagicbuilder.sourceconverter.UsingSimplePojoClassSample");
	}
