...
public class UsingSimplePojoClassSampleMagicBuilderAdvAsmProxyTinyAsmDump {
	...
	public static byte[] dump () throws Exception {
		return new UsingSimplePojoClassSampleMagicBuilderAdvAsmProxyTinyAsmDump().dump("cc1sj.tinyasm.advmagicbuilder.sourceconverter.UsingSimplePojoClassSampleMagicBuilderAdvAsmProxy");
	}
