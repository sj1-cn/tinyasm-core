...
public class ClazzTest {
	...
	public void testClazzTypeTypeArray() {
		assertEquals("[Lcc1sj/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).toString());
	}

	@Test
	public void testClazzTypeType() {
		assertEquals("Lcc1sj/tinyasm/ClazzTest;", new ClazzSimple(Type.getType(ClazzTest.class)).toString());
	}

	@Test
	public void testClazzTypeClassOfQ() {
		assertEquals("Lcc1sj/tinyasm/ClazzTest;", new ClazzSimple(ClazzTest.class).toString());
	}
	...
	public void testGetType() {
		assertEquals("[Lcc1sj/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).getType().getDescriptor());
	}

	@Test
	public void testSignatureAnyway() {
		assertEquals("[Lcc1sj/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).signatureAnyway());
	}
	...
	public void testGetDescriptor() {
		assertEquals("[Lcc1sj/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).getDescriptor());
	}

	@Test
	public void testSignatureOf() {
		assertEquals("[Lcc1sj/tinyasm/ClazzTest;", Clazz.of(ClazzTest.class, true).signatureOf());
	}
